...
# Sampled directly from a TryHackMe badge PNG (pixel analysis via Pillow,
# not a guess) so the stat icons use the same accent colors as THM's own
# badge - trophy/silver, streak/green, badge/magenta, follower/blue.
...
# measured directly), so the two badges sit at the same size side by side.
CARD_WIDTH = 329
CARD_HEIGHT = 88
CONTENT_X = 74
